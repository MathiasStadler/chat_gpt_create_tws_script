...
class BullPutSpread:
    ...
    def connect_to_tws(self):
        ...
        try:
            self.ib.connect('127.0.0.1', 7496, clientId=33)
    ...
    def find_bull_put_spread(self, symbol):
        ...
        try:
            ...
            # Example logic to find a bull put spread
            # A bull put spread involves selling a higher strike put and buying a lower strike put
            for chain in chains:
                puts = [opt for opt in chain if opt.right == 'P']
                ...
                if len(puts) >= 2:
                    ...
                    if sell_put.strike > buy_put.strike:
                        return {
                            ...
                            'premium': sell_put.last - buy_put.last
                        }
            return None
        except Exception as e:

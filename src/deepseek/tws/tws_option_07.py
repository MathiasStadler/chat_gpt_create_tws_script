...
class OptionDataFetcher:
    ...
    def fetch_option_chain(self):
        ...
        try:
            ...
            for contract in qualified_contracts:
                ...
                self.ib.sleep(1)  # Wait for the data to be populated
                tickers.append(ticker)

            # Wait for all market data to be populated
            self.ib.sleep(5)  # Adjust sleep time as needed
    ...
    def save_to_csv(self, data, expiry):
        ...
        try:
            with open(filename, 'w', newline='') as csvfile:
                fieldnames = ['symbol', 'strike', 'right', 'mid_price', 'bid', 'ask', 'delta', 'gamma', 'vega', 'theta']
    ...
    def print_option_data(self, data, expiry):
        ...
        for strike, values in sorted(strike_data.items()):
            ...
            call_ask = call['ask'] if call and call['ask'] is not None else 'N/A'
            ...
            put_ask = put['ask'] if put and put['ask'] is not None else 'N/A'

...
async def main():
    ...
    try:
        ...
        if portfolio:
            print("\n=== Open Positions ===")
            print(f"{'Symbol':<10} {'SecType':<8} {'Exchange':<10} {'Position':<10} {'Avg Cost':<15} {'Market Price':<15} {'Market Value':<15}")
            print("-" * 85)
            ...
            for position in portfolio:
                ...
                print(f"{symbol:<10} {secType:<8} {exchange:<10} {pos_size:<10} {avg_cost:<15.2f} {market_price:<15.2f} {market_value:<15.2f}")
        else:
        ...
        if positions:
            ...
            print(f"{'Symbol':<10} {'SecType':<8} {'Exchange':<10} {'Position':<10} {'Avg Cost':<15}")
            print("-" * 60)
            ...
            for pos in positions:
                ...
                print(f"{symbol:<10} {secType:<8} {exchange:<10} {pos_size:<10} {avg_cost:<15.2f}")
        else:

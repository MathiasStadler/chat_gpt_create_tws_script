...
class IBPositions:
    ...
    async def _process_portfolio(self, portfolio):
        ...
        for item in portfolio:
            try:
                # Get contract details for market data
                ...
                if contract_details:
                    ...
                    position_info = {
                        ...
                        "Market Price": ticker.last if ticker.last else ticker.close,
                        "Market Value": (ticker.last if ticker.last else ticker.close) * item.position,

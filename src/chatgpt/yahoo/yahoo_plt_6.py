...
Create a script for use the Python Library Yahoo Finance API with the following characteristics
    ...
    10. Add the Simple Moving average  200 and set the color of red
"""
...
class YahooFinanceAPI:
    ...
    def plot_chart(self):
        ...
        try:
            ...
            # Add 200-day Simple Moving Average (SMA) line
            ...
            fig.update_layout(
                title=f"{self.ticker} - Last 12 Months OHLC Chart with 200-Day SMA", 
                xaxis_title="Date", 
                yaxis_title="Price",

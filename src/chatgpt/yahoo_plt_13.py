...
12. add a subplot under the main plot and a volume plot that use the same y axis cursor from above plot
    ...
    def plot_data(self):
        try:
            ...
            fig.update_layout(
                ...
                yaxis2=dict(title='Volume', overlaying='y', side='right', showgrid=False, matches='y'),
                hovermode='x unified',  # Interactive cursor shared between plots

        ...
        try:
            ...
            for expiry in valid_expirations:
                try:
                    ...
                    # Convert columns to numeric, handling errors and filling NaNs
                    calls = calls[required_columns].apply(pd.to_numeric, errors='coerce').fillna(0)
                    puts = puts[required_columns].apply(pd.to_numeric, errors='coerce').fillna(0)
